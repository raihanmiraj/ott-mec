  ...
  <div className="flex flex-col gap-y-6 fixed z-20">
    <button>
      ...
      >
        ...
        <h4 className="text-md font-semibold tracking-wide">Home</h4>
      </div>
    </button>
    <button>
      <div
      ...
      >
        ...
        <h4 className="text-md font-semibold tracking-wide">React JS</h4>
      </div>
    </button>
    <button>
      <div
      ...
      >
        ...
        <h4 className="text-md font-semibold tracking-wide">DuaLipa</h4>
      </div>
    </button>
    <button>
      <div
      ...
      >
        ...
        <h4 className="text-md font-semibold tracking-wide">Comedy</h4>
      </div>
    </button>
    <button>
      <div
      ...
      >
        ...
        <h4 className="text-md font-semibold tracking-wide">Technology</h4>
      </div>
    </button>
    <button>
      <div
      ...
      >
        ...
        <h4 className="text-md font-semibold tracking-wide">Food</h4>
      </div>
    </button>
    <button>
      <div
      ...
      >
        ...
        <h4 className="text-md font-semibold tracking-wide">Travis Scott</h4>
      </div>
    </button>
    <button>
      <div
      ...
      >
        ...
        <h4 className="text-md font-semibold tracking-wide">Olivia Rodrigo</h4>
      </div>
    </button>
  </div>
</div>
