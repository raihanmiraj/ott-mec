import { getVideosFromDbByCategory, getVideosFromDbBySearch } from '@/services/videos.services';
...
const SearchPage = async ({name}) => {
    ...
    const data = await getVideosFromDbBySearch(decodeURIComponent(name))
